...
import (
	...
	"github.com/Cu3PO42/bl3-save-core/pkg/shared"
...
func Deserialize(reader io.Reader, magic shared.Magic) (shared.SavFile, pb.Character, error) {
